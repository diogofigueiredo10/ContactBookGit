...
public class Main {
    ...
    private static void searchByPhoneNumber(ContactBook cBook){
        if(cBook.getByPhoneNumber() != 0){
            System.out.println("Phone number does not exist.");
        } else {
            System.out.printf("%s", cBook.getByPhoneNumber());
        }
    }
}
