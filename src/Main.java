...
public class Main {
    ...
    public static final String DUPLICATE_FOUND = "There are contacts that share phone numbers.";
    public static final String NO_DUPLICATE = "All contacts have different phone numbers";
    ...
    private static void findDuplicates(ContactBook cBook) {
        if (cBook.hasDoubles()) {
            System.out.println(DUPLICATE_FOUND);
        } else System.out.println(NO_DUPLICATE);
    }
}
